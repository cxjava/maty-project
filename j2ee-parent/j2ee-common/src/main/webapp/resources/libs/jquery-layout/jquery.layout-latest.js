...
,	language: {
	...
	,	Pin:			"固定"
	,	Unpin:			"取消固定"
	,	noRoomToOpenTip: "没有足够的空间来显示此窗口。"
	,	minSizeWarning:	"窗口已经达到它的最小大小。"
	,	maxSizeWarning:	"窗口已经达到它的最大大小。"
	//	Developer error messages
	,	pane:					"窗格"		// description of "layout pane element"
	,	selector:				"选择器"	// description of "jQuery-selector"
	,	errButton:				"错误\n\n添加按钮无效"
	,	errContainerMissing:	"UI布局初始化错误\n\n指定的layout-container并不存在。"
	,	errCenterPaneMissing:	"UI布局初始化错误\n\ncenter-pane元素不存在的。 \n\n这个center-pane是一个必需的元素。"
	,	errContainerHeight:		"UI布局初始化警告\n\n这个layout-container\"CONTAINER\"没有高度。因此0-height布局“不可见”的！"
	}
